...
class WPMetrics_Widget_Extends
{
    /**
     * Construction
     */
    ...
    function extend_widget_form( $widget, $return, $instance )
    {
        ...
        <p>
            ...
            <label for="widget-<?php echo esc_attr( $widget->id_base . '-' . $widget->number ); ?>-use_theme_style"><?php esc_html_e( 'Use Theme Style', 'wp-metrics' ); ?></label>
        </p>
        <?php
        }
        ...
        <p>
            ...
            <label for="widget-<?php echo esc_attr( $widget->id_base . '-' . $widget->number ); ?>-hide_title"><?php esc_html_e( 'Hide widget title', 'wp-metrics' ); ?></label>
        </p>
        <?php
