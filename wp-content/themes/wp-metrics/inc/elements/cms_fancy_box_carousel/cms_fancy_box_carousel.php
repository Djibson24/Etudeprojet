...
$params = array_merge( 
    ...
    array(
        ...
        array(
            'type' => 'dropdown',
            'heading' => esc_html__( 'Elements per item', 'wp-metrics' ),
            'param_name' => 'per_col',
            'value' => array(
                '1' => '1',
                '2' => '2'
        ...
        array(
            ...
            'value' => array(
                ...
                esc_html__( 'Support for big image style', 'wp-metrics' ) => 'carousel-fancybox-imgicon'
            ),
            'description' => esc_html__( 'Built-in css support for particular fancybox layout.', 'wp-metrics' ),
        ),
        array(
            'type' => 'textfield',
...
vc_map( array(
    'name' => esc_html__( 'CMS Fancybox Carousel', 'wp-metrics' ),
    'base' => 'cms_fancybox_carousel',
    'as_parent' => array( 'only' => 'cms_fancy_box' ),
    ...
    'description' => esc_html__( 'Carousel for fancyboxes', 'wp-metrics' ),
    'js_view' => 'VcColumnView'
) );


class WPBakeryShortCode_CMS_Fancybox_Carousel extends WPBakeryShortCodesContainer {
    protected static $carousel_index = 1;
    public function __construct( $settings ) {
        parent::__construct( $settings );
        add_action( 'wp_enqueue_scripts', array( $this, 'jsCssScripts' ) );
    }
    ...
    public function jsCssScripts() {
        ...
        //wp_register_script( 'cshero-carousel', get_template_directory_uri() . '/js/theme.carousel.js', array( 'owl-carousel' ), '', true );
    }
