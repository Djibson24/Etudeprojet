    ...
    array(
        ...
        array(
            ...
            'value' => array(
                ...
                esc_html__( 'Support for testimonial with big left image', 'wp-metrics' ) => 'testimonial-carousel-img-big-left',
                esc_html__( 'Support for testimonial with small left image', 'wp-metrics' ) => 'testimonial-carousel-img-small-left',
                esc_html__( 'Support for testimonial with centered layout', 'wp-metrics' ) => 'testimonial-carousel-img-center',
            ),
...
vc_map( array(
    'name' => esc_html__( 'CMS Testimonial Carousel', 'wp-metrics' ),
    'base' => 'cms_testimonial_carousel',
    'as_parent' => array( 'only' => 'cms_testimonial' ),
    ...
    'description' => esc_html__( 'Carousel for testimonials', 'wp-metrics' ),
    'js_view' => 'VcColumnView'
) );

class WPBakeryShortCode_CMS_Testimonial_Carousel extends WPBakeryShortCodesContainer {
    ...
    protected function content( $atts, $content = null ) {
        if ( isset( $atts['cms_template'] ) && ! empty( $atts['cms_template'] ) ) {
    ...
    function getCarouselOptions( $atts ) {
        $data_attr = array();
