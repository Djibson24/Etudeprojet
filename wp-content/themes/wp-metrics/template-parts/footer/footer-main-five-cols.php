...
/**
 * Footer main 5 cols layout
 * Col widths are: 3, 2, 2, 2, 3
 */
?>
<?php if ( is_active_sidebar( 'footer-main-1-2' ) || is_active_sidebar( 'footer-main-3' ) || 
            is_active_sidebar( 'footer-main-4' ) || is_active_sidebar( 'footer-main-5' ) || is_active_sidebar( 'footer-main-6' ) ) : ?>
<div class="row">
    <?php if ( is_active_sidebar( 'footer-main-1-2' ) ) : ?>
    <div class="footer-main-col col-sm-4 col-md-3">
        <?php dynamic_sidebar( 'footer-main-1-2' ); ?>
    </div>
    <?php endif; ?>
