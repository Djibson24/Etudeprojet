...
if ( empty( $desc ) ) {
    $class_to_filter .= ' cms-heading-header-only';
}
...
$title_html = ( '' == trim( $title ) ) ? '' : '<h2 class="title"' . $title_style . '>' . wp_kses( trim( $title ), $allowed_html ) . '</h2>';
...
echo    '<div class="cms-heading cms-heading-with-desc">';
