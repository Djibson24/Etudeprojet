...
$css_class ='cms-testimonial cms-testimonial-img-left-small'; ?>
<div class="<?php echo esc_attr( $css_class ); ?>">
    <div class="testimonial-main"<?php echo $color_bg; ?>>
        <div class="testimonial-content">
            <div class="testimonial-icon testimonial-icon-before"<?php echo $color_icon; ?>><i class="fa fa-quote-right"></i></div>
