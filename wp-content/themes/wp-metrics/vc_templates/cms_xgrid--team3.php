...
<div class="<?php echo esc_attr( $css_class ); ?>" id="<?php echo esc_attr( $wrapper_id ); ?>">
    <div class="cms-grid cms-grid-team"<?php echo $items_data_attr; ?>>
        <?php ob_start(); ?>
            ...
            while ( $posts->have_posts() ) {
                ...
                <div class="grid-item <?php echo esc_attr( $item_class );?>"<?php echo $item_data_attr; ?>>
                    ...
                    switch( get_post_type() ) :
                        ...
                        case 'post':
                            get_template_part( 'template-parts/loops/loop-post', 'minimal' );
                            break;

                        case 'team':
                            get_template_part( 'template-parts/extra-loops/loop-team3' );
                            break;
