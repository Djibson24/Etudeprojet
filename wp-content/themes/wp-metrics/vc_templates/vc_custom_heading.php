 ...
 * @var $letter_spacing - Additional Parameter
 */
$source = $text = $link = $google_fonts = $font_container = $el_id = $el_class = $css = $css_animation = $font_container_data = $google_fonts_data = $letter_spacing = '';
...
$letter_spacing = empty( $letter_spacing ) ? '' : wpmetrics_validate_css_unit( $letter_spacing );
